...
public class RecordJourney extends AppCompatActivity {
    private com.example.runningtrackerapp.GifPlayer gif;
    private com.example.runningtrackerapp.LocationService.LocationServiceBinder locationService;
    ...
    private ServiceConnection lsc = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            locationService = (com.example.runningtrackerapp.LocationService.LocationServiceBinder) iBinder;
...
//        gif.pause();
        ...
        try {
            com.example.runningtrackerapp.MyReceiver receiver = new com.example.runningtrackerapp.MyReceiver();
